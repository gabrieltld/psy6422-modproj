...
(images are clickable links to the articles)

 <a href="https://www.bbc.co.uk/news/uk-scotland-52618931">
        <img border="0" alt="autism lockdown extra hard" src="headline images/autism lockdown extra hard.png" width="445" height="88" href="https://www.bbc.co.uk/news/uk-england-tyne-60885874">
        <img border="0" alt="school pupil autism rise" src="headline images/school pupil autism rise.png" width="400" height="80">
    </a>
    

 <a href="https://www.theguardian.com/society/2020/nov/11/siena-castellon-autistic-people-are-really-struggling-with-how-uncertain-things-are">
        <img border="0" alt="autism struggle uncertain" src="headline images/autism struggle uncertain.png" width="500" height="110" href="https://www.theguardian.com/society/2021/mar/29/autism-more-common-in-children-in-england-than-previously-thought-study">
        <img border="0" alt="autism more common" src="headline images/autism more common.png" width="400" height="100">
    </a>
...
brief_glance <- head(Apr19_Dec21[Apr19_Dec21$METRIC == 'ASD12' & Apr19_Dec21$SECONDARY_LEVEL != 'NONE'
                       & Apr19_Dec21$METRIC_VALUE != '*',], n=3)

knitr::kable(head(brief_glance))
```
...
the age group composition and make the proportions more directly comparable.
...
To emphasise the time course component of this data I animated the plot so that the data would be gradually revealed along the x-axis.
