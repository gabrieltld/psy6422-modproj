...
#tableh <- knitr::kable(head(brief_glance), "html", col.names =
#c("RPS","RPE","S","B","PL","PLD","SL","SLD","M","MD","MV"))
...
fval_tail <- function(df,col_num,value) {
  #find a value in the data frame that matches input 'value', find the element number of the last 
  #instance of this
...
#create an initial visualisation - here, a scatterplot
...
barplot <- ggplot(ref_age_date, aes(x=REPORTING_PERIOD_START,
  ...
  scale_y_continuous(breaks=seq(0,10500,500),expand = c(0,0), 
                     limits = c(0, 10500))+
...
```{r fig.show='animate', fig.width = 11, fig.asp = 0.6,interval = 0.1,echo=FALSE, warning = FALSE, message = FALSE, options(warn=0)}
